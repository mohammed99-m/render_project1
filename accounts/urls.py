...
urlpatterns = [
    ...
    path('sendjoinrequest/<str:trainer_id>/<str:coach_id>/',views.send_join_request,name="Send Join Request"),
    path('responsetojoinrequest/<str:coach_id>/<str:request_id>/<str:trainer_id>/',views.response_to_join_request,name="Response To Join Request"),
